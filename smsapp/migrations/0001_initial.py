# Generated by Django 2.2 on 2020-04-13 19:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Eng', 'English'), ('Math', 'Math'), ('Sci', 'Science'), ('Soc', 'Social'), ('EHP', 'Environment Health and Population'), ('OPT1', 'Optional Math'), ('OPT2', 'Economics')], max_length=20, verbose_name='Subject Name(s)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_teacher', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='smsapp.Teacher', verbose_name='Class Teacher')),
